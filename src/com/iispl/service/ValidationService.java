...
public class ValidationService {
	...
	public void validateXmlStructure(TransactionRequest transaction) throws InvalidXmlStructureException{
	...
	public void validateMandatoryFields(TransactionRequest transaction) throws InvalidTransactionException {
		
		if(transaction.getTransactionId() == null || transaction.getTransactionId().isBlank()) {
			throw new InvalidTransactionException();
		}
		
		if(transaction.getFromAccount() == null || transaction.getFromAccount().isBlank()) {
			throw new InvalidTransactionException();
		}
		
		if(transaction.getToAccount() == null || transaction.getToAccount().isBlank()) {
			throw new InvalidTransactionException();
		}
